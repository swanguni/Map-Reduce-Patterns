package com.examples.mr.usecases.kmeans;
...
public class KMeans {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Double[]/**
        		 ...
        		 * Date: 03/05/14
        		 * Time: 0.18
        		 */> centroids = Utils.createRandomCentroids(centroidsNumber);
    ...
    private static boolean launchJob(Configuration configuration) throws Exception {
        ...
        DistributedCache.addCacheFile(new Path(Constants.CENTROIDS_FILE).toUri(), configuration);
