...
public class MapSideJoinDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job firstSort = new Job(getConfiguration(keyIndex, separator));
        ...
        Job secondSort = new Job(getConfiguration(keyIndex, separator));
        ...
        Job mapJoin = new Job(getMapJoinConfiguration(separator, jobOneSortedPath, jobTwoSortedPath));
